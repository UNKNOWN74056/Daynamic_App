...
class Payment_page extends StatefulWidget {
  ...
  final Stores store;
  const Payment_page({super.key, required this.item, required this.store});
                          ...
                          ElevatedButton.icon(
                            ...
                            onPressed: () {
                              if (!validateprovider.isFormValid) {
                                ...
                                String emailto = widget.store.s67 ?? "";
